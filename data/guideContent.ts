...
export const GUIDE_CONTENTS: GuideContent[] = [
  ...
  },
  {
    ...
    callProfessional: 'If the whole house has low pressure and the issue is not from the main supply.',
      ifixitUrl: 'https://petermanhvac.com/blog/low-water-pressure/',
  },
  {
    id: 'clogged-sink',
    categoryId: 'home',
    ...
    callProfessional: 'If the clog keeps returning or affects multiple drains.',
      ifixitUrl: 'https://www.ifixit.com/Guide/How+to+Unclog+a+Sink+without+Harsh+Chemicals/147927',
  },
  {
    ...
    callProfessional: 'If water backs up badly or the clog seems deep in the pipe.',
      ifixitUrl: 'https://advancedsewer.com/2025/01/27/diy-fixes-for-a-slowly-draining-shower/',
  },
  {
    id: 'running-toilet',
    categoryId: 'home',
    ...
    callProfessional: 'If parts are replaced but the toilet still runs or leaks from the base.',
      ifixitUrl: 'https://www.ifixit.com/Guide/Toilet+Keeps+Running:+How+to+Fix+&+Maintain+Valve+Seat/133692',
  },
  {
    id: 'pipe-leak',
    categoryId: 'home',
    ...
    callProfessional: 'If the leak gets worse, the pipe is corroded, or the repair does not hold.',
      ifixitUrl: 'https://www.petersenproducts.com/articles/pipe-leak-repair-how-to-fix-a-leaking-pipe-without-replacing-it.html?srsltid=AfmBOorIVH4-I8p_jMjDuQOdfvVKSxOWh8ZWYnF_OZG7Kng_lrcKunBV',
  },
  {
    id: 'squeaky-hinges',
    categoryId: 'home',
    ...
    callProfessional: 'If the hinge is bent, broken, or the door frame is damaged.',
      ifixitUrl: 'https://www.hardwaresource.com/a/blog/post/how-to-fix-a-squeaky-door-hinge-avoiding-squeaky-hinges',
  },
  {
    id: 'door-wont-close',
    categoryId: 'home',
    ...
    callProfessional: 'If the frame is warped or the door has major alignment issues.',
      ifixitUrl: 'https://www.angi.com/articles/3-tips-fix-interior-door-wont-close-right.htm',
  },
  {
    id: 'loose-doorknob',
    categoryId: 'home',
    ...
    callProfessional: 'If the lock mechanism inside the door is damaged.',
      ifixitUrl: 'https://www.thespruce.com/tighten-a-loose-lever-doorknob-no-screws-1824825',
  },
  {
    id: 'stuck-window',
    categoryId: 'home',
    ...
    callProfessional: 'If the frame is warped or the glass feels unstable.',
      ifixitUrl: 'https://www.pjfitz.com/diy/window-repair/how-to-fix-a-stuck-window/',
  },
  {
    id: 'broken-lock',
    categoryId: 'home',
    ...
    ifixitUrl: 'https://www.angi.com/articles/when-broken-lock-isnt-broken-lock.htm',
  },
  {
    ...
    callProfessional: 'If cracks keep growing or appear near structural areas.',
       ifixitUrl: 'https://www.ultratechcement.com/for-homebuilders/home-building-explained-single/descriptive-articles/how-to-repair-cracks-in-walls',
  },
  {
    id: 'peeling-paint',
    categoryId: 'home',
    ...
    ifixitUrl: 'https://www.behr.com/consumer/how-to/interior/how-to-repair-peeling-paint',
  },
  {
    id: 'hole-drywall',
    categoryId: 'home',
    ...
    ifixitUrl: 'https://www.lowes.com/n/how-to/patch-and-repair-drywall',
  },
  {
    id: 'mold-spots',
    categoryId: 'home',
    ...
    ifixitUrl: 'https://www.rawlinspaints.com/blog/black-mould-on-walls-how-to-remove-it-and-stop-it-coming-back/',
  },
  {
    ...
    ifixitUrl: 'https://www.familyhandyman.com/article/fix-a-light/',
  },
  {
    id: 'loose-outlet',
    categoryId: 'home',
  ...
  },
  {
    ...
    ifixitUrl: 'https://www.thespruce.com/reset-a-tripped-breaker-4134193',
  },
  {
    id: 'bulb-flickering',
    categoryId: 'home',
    ...
    callProfessional: 'If multiple fixtures flicker or you notice burning smells.',
        ifixitUrl: 'https://www.thespruce.com/fix-a-flickering-light-bulb-4123638',
  },
  // APPLIANCES
  {
    id: 'wm-not-draining',
    ...
    callProfessional: 'If the pump is not working or makes unusual noises.',
       ifixitUrl: 'https://www.thespruce.com/washing-machine-wont-drain-2718776',
  },
  {
    id: 'wm-not-spinning',
    categoryId: 'appliances',
    ...
    callProfessional: 'If motor or belt issues are suspected.',
       ifixitUrl: 'https://www.ifixit.com/Troubleshooting/Washing_Machine/Not+Spinning/484555',
  },
  {
    id: 'wm-leaking',
    categoryId: 'appliances',
    ...
    callProfessional: 'If leak comes from inside the machine.',
        ifixitUrl: 'https://www.ifixit.com/Troubleshooting/Washing_Machine/Leaking/484423',
  },
  {
    id: 'wm-making-noise',
    categoryId: 'appliances',
    ...
    callProfessional: 'If noise comes from motor or bearings.',
        ifixitUrl: 'https://www.beko.ie/support/faqs/washing-machines/noisy-washing-machine',
  },
  {
    ...
    callProfessional: 'If compressor is not running.',
       ifixitUrl: 'https://www.familyhandyman.com/project/fix-refrigerator-problems/',
  },
  {
    id: 'fridge-leaking',
    categoryId: 'appliances',
    ...
    callProfessional: 'If leak continues after cleaning.',
       ifixitUrl: 'https://www.angi.com/articles/why-is-my-fridge-leaking.htm',
  },
  {
    ...
    callProfessional: 'If frost returns quickly.',
        ifixitUrl: 'https://hellosuper.com/tips/stop-ice-buildup-in-your-refrigerator',
  },
  {
    id: 'fridge-smell',
    categoryId: 'appliances',
    ...
    callProfessional: 'If smell persists without visible cause.',
       ifixitUrl: 'https://www.lowes.com/n/how-to/how-to-get-rid-of-fridge-smell',
  },
  {
    id: 'ac-weak-airflow',
    categoryId: 'appliances',
    ...
    callProfessional: 'If fan motor is weak.',
       ifixitUrl: 'https://www.cooltoday.com/blog/why-is-my-acs-airflow-suddenly-weak-answers-from-a-sarasota-tech',
  },
  {
    id: 'ac-not-cooling',
    categoryId: 'appliances',
    ...
    ifixitUrl: 'https://globalcoolair.com.au/news/aircon-not-blowing-cold-air-not-cooling/',
  },
  {
    id: 'ac-dirty-filter',
    categoryId: 'appliances',
    ...
    ifixitUrl: 'https://www.angi.com/articles/how-to-clean-an-air-conditioner-filter.htm',
  },
  {
    ...
    ifixitUrl: 'https://actronair.com.au/2025/07/11/why-is-my-aircon-leaking-water-5-common-causes-and-fixes/',
  },
  {
    ...
    callProfessional: 'Magnetron issue suspected.',
      ifixitUrl: 'https://www.maytag.com/blog/kitchen/how-to-repair-microwave-oven-not-heating.html',
  },
  {
    id: 'rice-cooker',
    categoryId: 'appliances',
    ...
    ifixitUrl: 'https://www.crompton.co.in/blogs/kitchen-appliances-guide/how-to-repair-a-rice-cooker',
  },
  {
    id: 'induction-pan',
    categoryId: 'appliances',
    ...
    callProfessional: 'If no cookware is detected at all.',
      ifixitUrl: 'https://www.mrappliance.com/blog/induction-cooktop-problems/',
  },
  // CAR
  {
    ...
    ifixitUrl: 'https://www.autozone.com/diy/battery/clean-car-battery-corrosion',
  },
  {
    id: 'dead-battery',
    categoryId: 'car',
    ...
    ifixitUrl: 'https://www.firestonecompleteautocare.com/blog/batteries/right-way-to-jumpstart-a-dead-battery/',
  },
  {
    id: 'loose-terminals',
    categoryId: 'car',
    ...
    ifixitUrl: 'https://www.carparts.com/blog/your-car-wont-start-a-loose-battery-connection-could-be-the-cause/?srsltid=AfmBOopx5afJXbcA9lVcgdjq_pSoD8yi5KBqTjr-4XmGm0JYhLCPdziI',
  },
  {
    id: 'flat-tire',
    categoryId: 'car',
    ...
    ifixitUrl: 'https://www.instructables.com/Fixing-a-Flat-Tire/',
  },
  {
    id: 'low-pressure',
    categoryId: 'car',
    ...
    ifixitUrl: 'https://www.wikihow.com/Tire-Losing-Pressure-but-No-Leak',
  },
  {
    id: 'uneven-wear',
    categoryId: 'car',
    ...
    ifixitUrl: 'https://www.unitedstarsauto.ca/how-to-fix-uneven-tire-wear-causes-and-solutions/',
  },
  {
    id: 'low-engine-oil',
    categoryId: 'car',
    ...
    ifixitUrl: 'https://mwg.aaa.com/automotive/auto-repair/articles/low-engine-oil-pressure-causes-symptoms-how-to-fix',
  },
  {
    id: 'coolant-check',
    categoryId: 'car',
    ...
    ifixitUrl: 'https://www.autozone.com/diy/engine-cooling/how-to-find-and-fix-coolant-leaks',
  },
  {
    id: 'brake-fluid',
    categoryId: 'car',
    ...
    ifixitUrl: 'https://www.carparts.com/blog/dirty-brake-fluid-causes-and-fixes/?srsltid=AfmBOopDof56a0N4e21esWHWty_DeYwB5Bkr6fKxqibncLiHxbo3BzjV',
  },
  {
    id: 'car-wont-start',
    categoryId: 'car',
    ...
    ifixitUrl: 'https://www.familyhandyman.com/article/car-wont-start-tips-what-to-do/',
  },
  {
    id: 'jumpstart',
    categoryId: 'car',
  ...
  },
  {
    ...
    ifixitUrl: 'https://www.caranddriver.com/features/a35865614/dashboard-warning-lights-explained/',
  },
  // ELECTRONICS
{
  ...
  ifixitUrl: 'https://dev.to/pavan_kumarprajapati_228/how-to-fix-phone-not-charging-properly-13-proven-methods-490n',
},
{
  ...
  ifixitUrl: 'https://medium.com/@imtiazahmad6321/how-to-fix-overheating-issues-permanently-on-android-smartphones-5fb8c6815287',
},
{
  id: 'slow-performance',
  categoryId: 'electronics',
  ...
  ifixitUrl: 'https://www.avast.com/c-how-to-speed-up-android',
},
{
  ...
  ifixitUrl: 'https://www.instructables.com/How-to-Fix-PC-Overheat-in-1-Minute-NO-TOOLS/',
},
{
  ...
  ifixitUrl: 'https://www.hp.com/sg-en/shop/tech-takes/post/how-do-i-fix-laptop-that-wont-turn-on',
},
{
  id: 'battery-draining',
  categoryId: 'electronics',
  ...
  ifixitUrl: 'https://onsitego.com/blog/laptop-battery-drain-problem-fix/',
},
{
  id: 'no-internet',
  categoryId: 'electronics',
  ...
  ifixitUrl: 'https://www.highspeedinternet.com/resources/no-internet-connection-troubleshooting-guide',
},
{
  id: 'slow-connection',
  categoryId: 'electronics',
  ...
  ifixitUrl: 'https://tuportal6.temple.edu/web/its/blog/-/blogs/tech-bits-10-tips-for-troubleshooting-a-slow-internet-connection',
},
{
  id: 'router-reset',
  categoryId: 'electronics',
  ...
  ifixitUrl: 'https://ubifi.net/blog/how-to-reset-a-router/',
},
{
  id: 'broken-charger',
  categoryId: 'electronics',
  ...
  ifixitUrl: 'https://www.carlcare.com/ng/tips-detail/fix-broken-charger/',
},
{
  ...
  ifixitUrl: 'https://www.americord.com/blogs/blog/extension-cord-fixes?srsltid=AfmBOooD1dXtv2ANMMUCUfDAAvruRLUo9_vfSR38eW_NkzDxR-0rFCcM',
},
{
  id: 'loose-plug',
  categoryId: 'electronics',
